...
import { deleteTicketAction } from "../../redux/ticketDetails/ticketActions";

const SingleDestination = ({ ticket }) => {
  // Dispatch
  const dispatch = useDispatch();

  // Extract data from props
  const { from, to, date, guest, classType, id } = ticket;
        ...
        <td className='px-6 py-4 text-center'>
          <div className='flex justify-center gap-4'>
            <button
              ...
              onClick={() => removeTicketHandler(id)}>
              <svg
